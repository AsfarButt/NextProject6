...
export default function HeroSection(){
    ...
    return(<div className="relative mt-18 pb-12 w-full h-auto border-b border-gray-300/30">
        <div className="herosection relative w-full h-auto flex flex-col justify-center items-center ">
            <div className="relative h-auto px-2 flex flex-col jusity-center items-center sm:w-[95%] md:w-[80%] lg:w-[70%] xl-w-[55%]" >
                <h1 className="text-4xl text-center font-bold sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">#1 GCSE</h1>
                <h1 className="text-4xl text-center font-bold sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">Revision Platform</h1>
                <div className="text-center text-[22px] sm:w-[80%] md:w-[70%] mt-8 text-gray-700/80 sm:text-2xl md:text-3xl">Join <p className="inline text-gray-800/80">10,000+ GCSE students</p> who are learning faster and scoring higher with diversonalised learning.</div>
                <button className="mt-12 w-84 px-2 h-14 sm:w-74 sm:h-18 md:w-80 md:h-18 bg-purple-600/95 rounded-2xl transition-all duration-300 cursor-pointer hover:scale-110 hover:brightness-90 hover:shadow-lg hover:shadow-black/30"><h1 className="text-white text-xl font-semibold pointer-events-none">Start Learning Smarter</h1></button>
            </div>
