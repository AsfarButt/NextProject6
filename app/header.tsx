...
export default function Header(){
    ...
    return(<div className="sticky top-0 w-full h-14 flex justify-center border-b-2 shadow-sm shadow-black/20 bg-white/95 border-gray-400/10 z-10">
        <div className="header relative px-2 w-full max-w-300 flex justify-between items-center sm:mx-2 md:mx-6 lg:mx-8 xl:mx-10">
